...
preprocess_test_data_filename = os.path.join(project_dir, "datasets", "preprocessed_smart_home_data.csv")
print(model_filename)
print(preprocess_test_data_filename)
...
X_test_sorted = X_test.sort_values(by="predicted_priority", ascending=False)
...
# Save predictions
output_path = os.path.join(project_dir, "datasets", "predicted_results.csv")
try:
